    ...
    async def start(self) -> bool:
        ...
        _any_allowlist = any(
            ...
            for v in ("TELEGRAM_ALLOWED_USERS", "DISCORD_ALLOWED_USERS",
                       ...
                       "ZULIP_ALLOWED_USERS", "FEISHU_ALLOWED_USERS", "WECOM_ALLOWED_USERS",
    ...
    def _create_adapter(
        ...
        if platform == Platform.TELEGRAM:
            ...
            if not check_feishu_requirements():
                logger.warning("Feishu: feishu package not installed or FEISHU_APP_ID/SECRET not set")
                return None
            ...
            if not check_wecom_requirements():
                logger.warning("WeCom: wecom package not installed or WECOM_BOT_ID/SECRET not set")
                return None
